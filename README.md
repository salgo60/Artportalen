...
* video [Öppna data och tjänster från SLU](https://www.youtube.com/playlist?list=PLOx9uiykwbE_YXo7wCggbpdMFHwdqMo1U) 
  * [Öppna data från SLU – information tillgänglig för vidareutnyttjande](https://www.slu.se/miljoanalys/statistik-och-miljodata/oppna-data-vid-slu/)
...
* [Kopplad 84 000 ggr](https://www.wikidata.org/wiki/Property_talk:P1939)
   * [Wikidata:Database reports/Constraint violations/P1939](https://www.wikidata.org/wiki/Wikidata:Database_reports/Constraint_violations/P1939)
